...
code("null_counts = df.isna().sum().sort_values(ascending=False)\n" "null_counts[null_counts > 0]")
code('death_null_rate = df["BENE_DEATH_DT"].isna().mean()\n' 'print(f"BENE_DEATH_DT null rate: {death_null_rate:.2%}")')
...
code('chronic_condition_count = (df[condition_cols] == "1").sum(axis=1)\n' "chronic_condition_count.describe()")
